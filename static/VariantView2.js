...
var aa_change_index = 11;
var gene_name_index = 9;
var ref_seq_id_index = 10;
...
var variant_file_name = "my_data.txt"
...
function draw_matrix_marks(){
    ...
    for(i = 0; i < patient_ids.length; i++){
        ...
        for(j = 0; j < patient_data.length; j++){
            ...
            if(patient_data[j][11].indexOf("missense_variant") != -1){
                colour = "#FF0000";
            }else{
...
function recurrence_histogram_bar() {
    ...
    if(nonsynonymous_filter_val == 0){
        ...
        filtered_variants = filtered_variants.filter(function(val) {
                                                     return (val[11].indexOf("missense_variant") == -1);
                                                     });
    ...
    if(frame_shift_val == 0){
        ...
        filtered_variants = filtered_variants.filter(function(val) {
                                                     return (val[11].indexOf("frameshift_variant") == -1);
                                                     });
    }
...
function drawProteinSummaryView(){
    ...
    for(i = 0; i < queried_gene_object.variant_objects.length; i++){
        ...
        if(queried_gene_object.variant_objects[i].var_entry[variant_type_index].indexOf("stop_gained") != -1){
            ...
            .attr("stroke-opacity", 1.0);
        }else if(queried_gene_object.variant_objects[i].var_entry[variant_type_index].indexOf("frameshift_variant") != -1){
        ...
        else if(queried_gene_object.variant_objects[i].var_entry[variant_type_index].indexOf("missense_variant") != -1){
        ...
        else if(queried_gene_object.variant_objects[i].var_entry[variant_type_index].indexOf("synonymous_variant") != -1){
